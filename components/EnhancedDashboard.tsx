...
const TrendChart = dynamic(() => import("@/components/charts/TrendChart").then(m=>m.TrendChart), { ssr: false, loading: () => <div className="h-48 rounded-md border card" /> });
const DonutChart = dynamic(() => import("@/components/charts/DonutChart").then(m=>m.DonutChart), { ssr: false, loading: () => <div className="h-48 rounded-md border card" /> });
